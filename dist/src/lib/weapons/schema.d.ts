...
export type WeaponSearchDbItem = WeaponSearchKeywordSchema & WeaponSearchMetadataSchema;
...
export type KeywordType<T extends WeaponSearchKeywords> = WeaponSearchKeywordSchema[T];
