...
export declare function buildSearchDatabase(defs: AllDestinyManifestComponents): import("./types").SearchDbItem[];
...
export declare function getSearchDb(): Promise<import("./types").SearchDbItem[]>;
